...
class CurriculumManager:
    ...
    1. Simple (easiest - foundational skills)
    2. Medium (intermediate difficulty)
    3. Complex (advanced level completion)
    4. Exploratory (requires exploration strategies)
    5. Mine heavy (hardest - requires precise control and mine avoidance)
    ...
    CURRICULUM_ORDER = ['simple', 'medium', 'complex', 'exploration', 'mine_heavy']
    
    def __init__(
        self,
        dataset_path: str,
        starting_stage: str = 'simple',
        ...
        Args:
            ...
            starting_stage: Initial curriculum stage (default: 'simple')
        ...
        self.stage_performance: Dict[str, deque] = {
            stage: deque(maxlen=performance_window)
    ...
    def get_stage_performance(self, stage: str) -> Dict[str, float]:
        ...
        can_advance = (
            success_rate >= self.advancement_threshold and
            episodes >= self.min_episodes_per_stage
        )
