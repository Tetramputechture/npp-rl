...
def create_dynamic_graph_env(
    ...
    if env_kwargs is None:
        env_kwargs = {
            ...
            'pbrs_gamma': 0.99,
            'use_graph_obs': True  # Enable graph observations
        }
    else:
        # Ensure graph observations are enabled
        env_kwargs = env_kwargs.copy()
        env_kwargs['use_graph_obs'] = True
...
class DynamicGraphProfiler:
    ...
    def record_operation(self, operation_name: str, duration_ms: float, metadata: Optional[Dict[str, Any]] = None):
