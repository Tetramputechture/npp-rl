...
class PoolingConfig:
    ...
    def cnn_flattened_size(self) -> int:
        ...
        return self.cnn_final_channels * self.adaptive_pool2d_output_size[0] * self.adaptive_pool2d_output_size[1]
...
CNN_CONFIG = CNNArchitectureConfig(
    ...
    conv3d_layer1=ConvLayerConfig(
        ...
        kernel_size=(4, 7, 7), stride=(2, 2, 2), padding=(1, 3, 3)
    ),
    conv3d_layer2=ConvLayerConfig(
    ...
    conv3d_layer3=ConvLayerConfig(
        ...
        kernel_size=(2, 3, 3), stride=(1, 2, 2), padding=(0, 1, 1)
    ),
