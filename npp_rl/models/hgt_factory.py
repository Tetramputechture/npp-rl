...
try:
    ...
    logging.warning("PyTorch Geometric not available. Using custom HGT implementation only.")
...
def validate_hgt_installation() -> Dict[str, Any]:
    """
    Validate HGT installation and dependencies.
    ...
    results = {
        ...
        "custom_hgt_available": True,
        "production_ready": True
    }
    
    try:
        # Test basic HGT creation
        config = ProductionHGTConfig()
        factory = HGTFactory(config)
        
        # Test layer creation
        layer = factory.create_hgt_layer()
        results["layer_creation"] = True
        
        # Test encoder creation
        encoder = factory.create_hgt_encoder()
        results["encoder_creation"] = True
        
        # Test multimodal system creation
        multimodal = factory.create_multimodal_hgt_system()
        results["multimodal_creation"] = True
...
if __name__ == "__main__":
    # Validation when run as script
    results = validate_hgt_installation()
    print("HGT Installation Validation:")
