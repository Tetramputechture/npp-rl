...
class MineAwareSubtaskContext:
    ...
    def get_safe_path_score(
        ...
        Args:
            ...
            mines_blocking_path: Number of mines blocking the path
        ...
        if mines_blocking_path == 0:
            return 1.0
        elif mines_blocking_path >= 3:
            return 0.0
        else:
            # Gradual decrease with more mines
            return 1.0 - (mines_blocking_path / 3.0)
    ...
    def modulate_subtask_priority(
        ...
        Args:
            base_priority: Base priority for subtask [0, 1]
            path_safety: Safety of path to objective [0, 1]
            mine_danger: Mine danger score [0, 1]
            
        Returns:
            Modulated priority [0, 1]
        """
        # Reduce priority if path is dangerous
        safety_factor = path_safety * (1.0 - mine_danger * 0.5)
