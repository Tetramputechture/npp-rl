...
def parse_arguments():
    ...
    parser.add_argument(
        "--dataset_dir",
        type=str,
        default="datasets/shards",
        help="Directory containing replay data",
    )
    parser.add_argument(
        "--create_mock_data", action="store_true", help="Create mock data for testing"
    )
    ...
    parser.add_argument(
        "--run_name", type=str, default="bc_pretrain", help="Run name for logging"
    )

    # Other arguments
    parser.add_argument("--device", type=str, default="auto", help="Device to train on")
    parser.add_argument(
        "--max_episodes", type=int, default=None, help="Maximum episodes to load"
    )
...
def setup_data(args):
    ...
    if args.create_mock_data:
        ...
        create_mock_replay_data(
            output_dir=args.dataset_dir, num_episodes=100, episode_length=200
        )
